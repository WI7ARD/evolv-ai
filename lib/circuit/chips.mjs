...
export function chipDriver(component, read, state = null) {
  ...
  switch (component.kind) {
    ...
    case "gate": {
      ...
      return {
        volts: output ? supply - CHIP_MODELS.logic.headroom : CHIP_MODELS.logic.headroom,
    ...
    case "flipflop": {
      ...
      const top = supply - CHIP_MODELS.logic.headroom;
    ...
    case "timer555": {
      ...
      return {
        volts: set ? supply - 1.7 : 0.25,   // A bipolar 555 loses well over a volt at the top.
        resistance: 10,
        reference: "gnd",
        logic: set,
    ...
    case "mcupin": {
      ...
      return {
        volts: mode === "high" ? supply - CMOS_HEADROOM : CMOS_HEADROOM,
        resistance: 25,
        reference: "gnd",
        logic: mode === "high"
      };
