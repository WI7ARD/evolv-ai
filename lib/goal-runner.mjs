import { agentMayRunStep, agentModelOverride, agentSystemPrompt, resolveAgent } from "./agents.mjs";
    ...
    while (true) {
      ...
      try {
        ...
        if (["analyze", "verification", "report"].includes(active.kind)) {
          ...
          const stepAgent = resolveAgent(this.#plannedStep(current, active)?.agent, { step: { type: active.kind } });
