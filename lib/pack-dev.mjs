...
export function watchPackSource(root, onChange) {
  // Canonical, not merely resolved: fs.watch on a path the filesystem spells
  // differently aborts the process on Windows. See lib/canonical-path.mjs.
  const resolvedRoot = canonicalRootSync(root);
  const watchers = [];
