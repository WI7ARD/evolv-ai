...
// every install on it. Reading the shipped version keeps that gate honest: a
// hardcoded literal silently rejects any pack authored against a release newer
// than the last time someone remembered to edit it.
function installedEvolvVersion() {
  try {
  ...
  } catch { /* fall back to the floor below rather than failing to start */ }
  return "0.4.0";
}

export const EVOLV_VERSION = installedEvolvVersion();
